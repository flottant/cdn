(function(){const translate=GLOBAL_CONFIG.translate
    ...
    let targetEncoding=Cookies.get(targetEncodingCookie)===undefined?defaultEncoding:Number(Cookies.get(targetEncodingCookie))
    ...
    translateBody()
    if(isSnackbar)snackbarShow(snackbarData.cht_to_chs)}else if(targetEncoding===2){currentEncoding=2
    targetEncoding=1
    ...
    if(translateButtonObject){if(currentEncoding!==targetEncoding){setTimeout(function(){translateBody()},translateDelay)
